...
//$yourEmail = "matthewhensrud@gmail.com"; // the email address you wish to receive these mails through
$yourWebsite = "H.U.F. Awards"; // the name of your website
$thanksPage = 'volunteer_thanks.php'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
	...
	if ($error_msg == NULL && $points <= $maxPoints && $resp->is_valid) {
		...
		$subject = "Volunteer Applicaton Submitted";

		$message = "An Volunteer Application has been submitted: \n\n";
		...
		if (empty($error_msg))
			$error_msg = 'Your mail looks too much like spam, or the Recaptcha was incorrect, and could not be sent. ['.$points.']';
	}
}
...
if ($error_msg != NULL) {
	...
	<br/><br/>
	<a href="volunteer_form.php" target="_self">Try again</a>
	</p>';
}
?>
