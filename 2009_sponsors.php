...
<div class="content">
<img src="images/sponsorships_header.jpg" width="174" height="24" alt="Sponsorships">


<p style="color: #a7262d;"><hr width="500" align="left"></p>

<p class="performers_links"><em><strong>View Past Sponsors:</strong></em>
<?  include("sponsor_nav.html");?>
	<div class="sponsor_app_btn"><a href="pdf/Sponsorship_Application.pdf" target="_blank">Sponsorship Application Button</a></div>
...
<p><blockquote style="width: 570px;"><strong>2009 SPONSORS</strong>

 <div class="sponsorlogos">
	Arnold Hackett of Xerox<br>
	      Mu Chi Chapter of Chi Eta Sorority, Inc.<br>
	        Spectrum International Beauty Expo<br>
	        David Rice/Spa 313<br>
	    Wells Fargo Bank<br>
	    UPS<br>
	    Union Bank<br>
	    Brotherhood Crusade<br>
	    Broadway Federal Bank<br><br>
	    Castillo Charitable Foundation
	    Northrop Grumann<br>
