...
<ul>
<li style="color: red;">Application must be received by May 1, 2012</li>
</ul>
  <form action="mail_form_volunteers.php" method="post" enctype="multipart/form-data" name="form1" id="form1">  
  <fieldset>
...
<fieldset>
  ...
  <p style="margin: 0px; padding: 10px; float: left; display:block; width:100%">
...
<span class="textfieldInvalidFormatMsg">Invalid format.</span></span>
  ...
  <p style="margin: 0px; padding: 10px; float: left; display:block; width:100%;"><span id="sprytextfield11">
...
<span class="textfieldInvalidFormatMsg">Invalid format.</span></span> </p>
<p style="margin: 0px; padding: 10px; float: left; display:block; width:100%;"><span id="sprytextfield14">
    <input name="area5" type="text" class="lebelleft" id="area5" size="3" maxlength="1" />
    <label for="area5">VIP Escort</label>
    <span class="textfieldInvalidFormatMsg">Invalid format.</span></span> </p>

    <p style="margin: 0px; padding: 10px; float: left; display:block; width:100%;"><span id="sprytextfield25">
...
<span class="textfieldInvalidFormatMsg">Invalid format.</span></span> </p>
<p style="margin: 0px; padding: 10px; float: left; display:block; width:100%;"><span id="sprytextfield28">
...
Mablean Ephriam Foundation / H.U.F.<span class="checkboxMinSelectionsMsg">Minimum number of selections not met.</span><span class="checkboxMaxSelectionsMsg">Maximum number of selections exceeded.</span></span>
  </p>
  <p>
...
Other Organizations / Groups<span class="checkboxMinSelectionsMsg">Minimum number of selections not met.</span><span class="checkboxMaxSelectionsMsg">Maximum number of selections exceeded.</span></span></p>
</fieldset>
    <br/>
    <fieldset>
...
var sprycheckbox2 = new Spry.Widget.ValidationCheckbox("sprycheckbox2", {isRequired:false, minSelections:0, maxSelections:1});
